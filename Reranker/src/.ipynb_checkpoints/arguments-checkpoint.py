...
class ModelArguments:
    ...
    teacher_model_path: str = field(
        metadata={"help": "Path to pretrained model as teacher"}
    )
    student_tokenizer_path: str = field(
        metadata={"help": "Path to student models tokenizer"}
    )
    ...
    kd_weight: float = field(
        metadata={"help": "knowledge distillation loss weightage"}
    )
